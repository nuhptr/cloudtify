export const sidebarLinks = [
   { imgURL: "/icons/ic_home.svg", route: "/", label: "Home" },
   { imgURL: "/icons/ic_discover.svg", route: "/discover", label: "Discover" },
   { imgURL: "/icons/ic_microphone.svg", route: "/create-podcast", label: "Create Podcast" },
]
